...
public class CadastroLancamentoBean implements Serializable {
	...
	private Date dataVencimentoAlterada;
	...
	public Date getDataVencimentoAlterada() {
		return dataVencimentoAlterada;
	}

	public void setDataVencimentoAlterada(Date datavencimentoalterada) {
		this.dataVencimentoAlterada = datavencimentoalterada;
	}
